                                        ...
                                        <div class="card-body">
                                            <form action="prediksi.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" id="nim" name="nim" placeholder="Masukkan NIM" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama">Nama Mahasiswa</label>
                                                    <input class="form-control" type="text" id="nama_mahasiswa" name="nama_mahasiswa" placeholder="Masukkan Nama Lengkap" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="prodi" name="prodi" placeholder="Masukkan Program Studi" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nilai">Nilai IPK</label>
                                                    <input class="form-control" type="text" id="nilai_ipk" name="nilai_ipk" placeholder="Masukkan Nilai IPK" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="kompensasi">Kompensasi</label>
                                                    <input class="form-control" type="number" id="kompensasi" name="kompensasi" placeholder="Masukkan Total Kompen permenit" required>
                                                </div>
                                                <div class="form-group pull-right">
                                                    <input name="submit" type="submit" value="Prediksi" class="btn btn-success">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
