                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pull-right">
                                ...
                                <a class="btn btn-primary" href="generate.php"><i class="ti-plus"></i><h8> &nbspTambah Data Lagi</h8></a>
                            </div>
                                    ...
                                    <form action="proses.php" method="post">
                                        ...
                                        <table class="table">
                                            <tr>
                                                ...
                                                <th scope="col">Kompensasi/Menit</th>
                                            ...
                                            <?php
                                                for ($i=1; $i<=$_POST['count_add']; $i++) { ?>
                                                    <tr>
                                                        <td><?=$i ?> </td>
                                                        <td>
                                                            <input type="number" min="1" name="nim<?=$i?>" class="form-control" placeholder="Masukkan NIM" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="nama_mahasiswa<?=$i?>" class="form-control" placeholder="Masukkan Nama Lengkap" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="nilai_ipk<?=$i?>" class="form-control" placeholder="Min. 1.00 - Max. 4.00" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="kompensasi<?=$i?>" class="form-control" placeholder="Masukkan Total Kompensasi" required>
                                                        </td>
                                                        <td>
                                                            <select name="class<?=$i?>" class="custom-select" required>
                                                        ...
                                                        <td>
                                                            <input type="hidden" name="status<?=$i?>" class="form-control">
                                                        </td>
                                                    </tr>         
                                            <?php           
                                                }
                                        ...
                                        <div class="form-group pull-right">
                                            <input name="add" type="submit" value="Simpan" class="btn btn-success">
                                        </div>
                                    </form>
                                </div>
                            </div>
